  ...
  nodes: [
    {
      ...
      properties: [
        { key: 'apiKey', label: 'API Key', type: 'text', required: true, tooltip: 'FishAudio API Key' },
        { key: 'text', label: '文字内容', type: 'textarea', required: true, tooltip: '要转换为语音的文字' },
        { key: 'referenceId', label: '音色模型 ID', type: 'text', tooltip: '音色模型 ID（可在 fish.audio 模型市场获取）' },
